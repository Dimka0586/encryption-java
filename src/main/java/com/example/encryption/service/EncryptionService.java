...
public class EncryptionService {
    ...
    public String createSecretKey(String attributeId, String encodedPubKey) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, InvalidAlgorithmParameterException, BadPaddingException, IllegalBlockSizeException {
        ...
        mockStorage.putAes(attributeId, secretKey);
    ...
    public void decryptWithAES(String encoded, SecretKey aes) throws BadPaddingException, IllegalBlockSizeException, InvalidKeyException, NoSuchPaddingException, NoSuchAlgorithmException, InvalidAlgorithmParameterException {
        byte[] nonceAndCounter = new byte[16];
        IvParameterSpec ivSpec = new IvParameterSpec(nonceAndCounter);
        Cipher cipher = Cipher.getInstance("AES/CTR/NoPadding");
        cipher.init(Cipher.DECRYPT_MODE, aes, ivSpec);
        byte[] result = cipher.doFinal(Base64.decodeBase64(encoded));
